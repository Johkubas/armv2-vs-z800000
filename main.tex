...
Kompiuterių architektūrų raida suintensyvėjo XX a. devintajame dešimtmetyje,
kai rinkoje pradėjo atsirasti vis daugiau 16 ir 32 bitų mikroprocesorių,
skirtų tiek asmeniniams kompiuteriams, tiek įterptinėms ir pramoninėms sistemoms.
Šiuo laikotarpiu formavosi skirtingos architektūrinės kryptys, iš kurių dvi
ryškiausios buvo RISC (Reduced Instruction Set Computer) ir CISC
(Complex Instruction Set Computer).

Šiame darbe lyginamos dvi to paties laikotarpio, tačiau skirtingų filosofijų
kompiuterių architektūros: \textbf{ARMv2} ir \textbf{Zilog Z80000}. Abi šios
architektūros buvo kuriamos XX a. pabaigoje ir atspindi skirtingą požiūrį į
procesoriaus sudėtingumą, našumą ir pritaikymo sritis. ARMv2 yra ankstyvosios
RISC architektūros pavyzdys, orientuotas į paprastumą ir energijos taupymą, o Z80000 atstovauja sudėtingesnei CISC krypčiai, siekusiai didesnio
funkcionalumo vienoje instrukcijoje.

\textbf{Šio darbo tikslas} – palyginti ARMv2 ir Z80000 architektūras, išanalizuoti
jų pagrindines technines savybes, veikimo principus bei pritaikymo galimybes.

\textbf{Darbo uždaviniai:}
\begin{itemize}
    \item apžvelgti abiejų architektūrų elementinę bazę ir fizines savybes;
    \item nustatyti architektūrų tipus, adresavimo principus ir registrų organizavimą;
    \item palyginti atminties organizavimą, virtualiosios atminties palaikymą,
    pertraukimų veikimą;
    \item išanalizuoti komandų sistemas, adresavimo būdus ir duomenų tipus;
    \item palyginti greitaveiką, spartinančiąją atmintį ir taikymo sritis;
    \item įvertinti programinės įrangos ir emuliavimo galimybes.
\end{itemize}

\textbf{Darbo metodai} – techninės dokumentacijos, mokomosios literatūros ir
internetinių šaltinių analizė bei lyginamoji dviejų architektūrų savybių apžvalga.
Darbas buvo rengiamas naudojant versijų valdymo sistemą GitHub ir Latex dokumentų
rengimo sistemą.
...
\texttt{CPSR} (Current Program Status Register) \cite{ChatGPT2025}. Šie bitai
...
\section{Spartinančioji atmintis (Cache)}

\subsection{ARMv2 spartinančioji atmintis}

Ankstyvieji ARMv2 procesoriai \textbf{neturėjo integruotos spartinančiosios
atminties (cache)} pačiame procesoriaus branduolyje. Visos instrukcijos ir
duomenys buvo imami tiesiogiai iš pagrindinės operatyviosios atminties (RAM).

Kai kuriose sistemose spartinančioji atmintis galėjo būti realizuota
\textbf{išoriniais mikroschemų sprendimais}, tačiau tai nebuvo standartinė
ARMv2 architektūros dalis.

ARMv2 atveju:
\begin{itemize}
    \item integruotos cache atminties nebuvo,
    \item viskas priklausė nuo išorinės sistemos realizacijos,
    \item architektūra buvo orientuota į paprastumą ir mažas energijos sąnaudas.
\end{itemize}


\subsection{Zilog Z80000 spartinančioji atmintis}

Z80000 architektūra taip pat \textbf{neturėjo integruotos spartinančiosios
atminties} pačiame procesoriuje. Kaip ir ARMv2 atveju, visa pagrindinė atminties
prieiga vyko tiesiogiai į RAM.

Tačiau kai kurios Z80000 pagrindu kurtos sistemos galėjo turėti
\textbf{išorinę cache atmintį}, skirtą pagreitinti dažniausiai naudojamų
duomenų ir instrukcijų prieigą.

\subsection{Palyginimas}

\begin{itemize}
    \item Nei ARMv2, nei Z80000 neturėjo integruotos spartinančiosios atminties.
    \item Abiejų architektūrų našumas priklausė nuo pagrindinės
    operatyviosios atminties greičio.
    \item Išorinė spartinančioji atmintis galėjo būti naudojama tik kaip
    papildomas sistemos sprendimas.
\end{itemize}

\section{Tipinės taikymo sritys}

\subsection{ARMv2 taikymo sritys}

ARMv2 architektūra dažniausiai buvo naudojama \textbf{įterptinėse sistemose},
kur svarbus mažas energijos suvartojimas, paprastas valdymas ir patikimumas.
Šie procesoriai buvo montuojami į valdymo įrenginius, pramoninius kontrolerius,
medicinos prietaisus ir įvairią buitinę elektroniką.

Vienas konkretus ARMv2 panaudojimo pavyzdys – \textbf{Acorn Archimedes}
kompiuteriai. Tai buvo asmeniniai kompiuteriai, kurie dėl ARM procesoriaus
pasižymėjo greitu veikimu ir mažu triukšmu, nes nereikėjo aktyvaus aušinimo.
Jie buvo naudojami mokyklose, programavimui ir grafiniams darbams.

\subsection{Zilog Z80000 taikymo sritys}

Z80000 buvo orientuotas į \textbf{galingesnes skaičiavimo sistemas}, tokias kaip
darbo stotys, valdymo sistemos, telekomunikacijų įranga.

Konkretus panaudojimo pavyzdys – \textbf{Unix tipo sistemos ir
tinklo valdymo įrenginiai}, kuriuose reikėjo didesnės skaičiavimo galios,
virtualiosios atminties palaikymo ir sudėtingesnio įrenginių valdymo.
Z80000 buvo tinkamas tokioms sistemoms dėl savo lanksčios CISC architektūros.

\subsection{Palyginimas}

\begin{itemize}
    \item ARMv2 buvo labiau orientuotas į \textbf{efektyvias, mažai
    energijos naudojančias sistemas}.
    \item Z80000 buvo skirtas \textbf{galingesnėms ir universalesnėms
    skaičiavimo sistemoms}.
    \item ARMv2 dažniau sutinkamas buitinėje ir pramoninėje elektronikoje,
    o Z80000 – sudėtingesnėse kompiuterinėse sistemose.
\end{itemize}

\section{Programinė įranga ir kūrimo įrankiai}

\subsection{ARMv2 programinė įranga}

ARMv2 architektūrai buvo sukurta nemažai programinės įrangos, skirtos
įterptinėms sistemoms ir asmeniniams kompiuteriams. Plačiausiai žinoma sistema,
naudojusi ARMv2, buvo \textbf{Acorn Archimedes}, kuriai buvo kuriamos operacinės
sistemos ir taikomosios programos.

ARMv2 kūrimo įrankiai:
\begin{itemize}
    \item Asamblėriai (ARM assembler),
    \item C kalbos kompiliatoriai,
    \item Debuggeriai,
    \item Paprasti profiliavimo įrankiai.
\end{itemize}

Didelė dalis programinės įrangos buvo orientuota į valdymo sistemas,
grafines vartotojo aplinkas ir edukacines programas.

\subsection{Zilog Z80000 programinė įranga}

Z80000 architektūrai buvo kuriama programinė įranga, skirta sudėtingesnėms
darbo stotims ir tinklo sistemoms. Buvo bandoma pritaikyti \textbf{Unix tipo
operacines sistemas}, taip pat kuriamos specializuotos realaus laiko sistemos.

Z80000 kūrimo įrankiai:
\begin{itemize}
    \item Asamblėriai (Zilog assembler),
    \item C ir kitų aukšto lygio kalbų kompiliatoriai,
    \item Programų derintojai,
    \item Sistemos testavimo ir diagnostikos įrankiai.
\end{itemize}

Kadangi Z80000 nebuvo plačiai paplitęs masinėje rinkoje, jo programinės
įrangos ekosistema liko gana ribota.

\subsection{Palyginimas}

\begin{itemize}
    \item ARMv2 turėjo \textbf{platesnį programinės įrangos palaikymą},
    ypač įterptinių sistemų srityje.
    \item Z80000 programinė įranga buvo labiau orientuota į
    \textbf{specializuotas ir eksperimentines sistemas}.
    \item Abiem architektūroms buvo prieinami asamblėriai, C kompiliatoriai
    ir derinimo įrankiai.
\end{itemize}

\section{Emuliatoriai}

\subsection{ARMv2 emuliatoriai}

ARMv2 architektūrai egzistuoja keli emuliavimo sprendimai, kurie leidžia
paleisti senas programas arba testuoti sistemas be fizinės aparatinės
įrangos. Dažniausiai ARMv2 palaikymas yra įtrauktas į bendrus ARM
emuliatorius.

Populiariausi sprendimai:
\begin{itemize}
    \item \textbf{QEMU} - palaiko ankstyvas ARM architektūras ir leidžia
    emuliuoti ARM pagrindu veikiančias sistemas.
    \item Specializuoti Acorn Archimedes emuliatoriai, skirti ARM2/ARMv2.
\end{itemize}

Šie emuliatoriai leidžia paleisti seną programinę įrangą, testuoti kodą ir
mokytis ARM architektūros veikimo principų.

\subsection{Zilog Z80000 emuliatoriai}

Z80000 architektūrai emuliatorių yra žymiai mažiau, nes pats procesorius
nebuvo plačiai paplitęs. Dauguma sprendimų yra:
\begin{itemize}
    \item akademiniai projektai,
    \item eksperimentiniai emuliatoriai,
\end{itemize}

Pilnai funkcionalių, plačiai naudojamų Z80000 emuliatorių šiuo metu yra
nedaug, todėl ši architektūra dažniausiai tiriama remiantis dokumentacija,
o ne realiu emuliavimu.

\subsection{Palyginimas}

\begin{itemize}
    \item ARMv2 turi žymiai daugiau prieinamų emuliatorių ir testavimo
    įrankių.
    \item Z80000 emuliavimas yra ribotas ir daugiausia eksperimentinis.
    \item ARMv2 architektūrą lengviau studijuoti praktiniu būdu naudojant
    emuliatorius.
\end{itemize}

\section{Išvados}

Šiame darbe buvo palygintos dvi to paties laikotarpio architektūros – ARMv2 ir
Zilog Z80000 – kurios atstovauja skirtingas RISC ir CISC projektavimo filosofijas.
ARMv2 pasižymėjo paprastumu, dideliu efektyvumu ir mažu energijos
suvartojimu, todėl buvo plačiai naudojamas įterptinėse sistemose.
Z80000 buvo sudėtingesnis, lankstesnis ir labiau orientuotas į universalias
skaičiavimo sistemas su virtualiosios atminties palaikymu.
Abi architektūros turėjo savų privalumų ir buvo pritaikytos skirtingoms
naudojimo sritims.


\section{Naudoti šaltiniai}

Šiame darbe naudota informacija buvo surinkta iš techninių gamintojų dokumentacijų,
Vikipedijos straipsnių, skaitmeninių archyvų ir internetinių šaltinių. Visi šaltiniai
cituojami Harvardo stiliumi, o pilnas sąrašas pateikiamas žemiau.
